...
- [ ] T073 [US1] Have the orchestrator review the metadata lock and record READY, BLOCKED or NEEDS_AUTHORIZATION before T019 in experiments/001-resource-efficient-finetune/reports/runtime-metadata-review.md per Constitution II and G1 (missing)
