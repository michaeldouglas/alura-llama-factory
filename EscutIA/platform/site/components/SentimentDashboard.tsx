...
export default function SentimentDashboard({ initialSummary, initialSelected = [...SENTIMENT_LABELS], initialRecords, section = "overview" }: SentimentDashboardProps) {
  ...
  async function applyFilters() {
    ...
    try {
      ...
      window.history.replaceState(null, "", `${routePath}?${makeQuery(from, to, selected)}`);
