      ...
      <div className="site-container">
        <div className="relative overflow-hidden rounded-[34px] bg-gradient-brand px-7 py-14 text-center text-white shadow-2xl shadow-pink/20 sm:px-12 sm:py-20">
          ...
          <div className="relative mx-auto max-w-2xl">
            <p className="text-sm font-black uppercase tracking-[0.15em] text-white/75">quando quiser, estamos aqui</p>
            <h2 className="mt-5 text-4xl font-black tracking-[-0.04em] sm:text-5xl">Você não precisa guardar tudo para você.</h2>
            <p className="mx-auto mt-5 max-w-lg text-lg leading-8 text-white/80">Quando quiser conversar, a EscutIA estará aqui.</p>
