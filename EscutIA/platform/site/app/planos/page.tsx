...
export const metadata: Metadata = { title: "Planos e preços", description: "Compare os planos da EscutIA, seus limites de respostas e os recursos disponíveis em cada opção." };
