    ...
    <main id="main-content" className="min-h-screen bg-[#f9f6f3] text-navy lg:flex">
      ...
      <div className="min-w-0 flex-1">
        <div className="mx-auto w-full max-w-[980px] px-5 py-8 sm:px-8 sm:py-10 lg:px-12 lg:py-14">
          <header><p className="eyebrow">conta e dados</p><h1 className="mt-3 text-4xl font-black tracking-[-0.06em] sm:text-6xl">Seu espaço pessoal</h1><p className="mt-3 max-w-xl text-sm leading-7 text-navy/55 sm:text-base">Veja o que a EscutIA mantém, baixe seus registros ou remova os dados que não deseja mais guardar.</p></header>
