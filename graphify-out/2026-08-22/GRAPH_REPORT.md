...
## Corpus Check
- 117 files · ~216,676 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 620 nodes · 988 edges · 50 communities (40 shown, 10 thin omitted)
...
## Knowledge Gaps
- **194 isolated node(s):** `$schema`, `gate_id`, `decision`, `approved_at`, `scope_hash` (+189 more)
