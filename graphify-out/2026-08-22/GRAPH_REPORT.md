...
## Corpus Check
- 82 files · ~196,097 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 426 nodes · 591 edges · 35 communities (27 shown, 8 thin omitted)
...
7. `Quickstart Validation Guide: Resource-Efficient First Fine-Tuning Experiment` - 11 edges
8. `Research: Resource-Efficient First Fine-Tuning Experiment` - 11 edges
9. `validate_heavy_artifact_path()` - 10 edges
10. `Requirement` - 10 edges
...
Cohesion: 0.05
Nodes (34): Data Model: Resource-Efficient First Fine-Tuning Experiment, DatasetSource, Entity Overview, EnvironmentProfile, EvaluationRecord, ExecutionProposal, ExperimentRun, ExperimentSpecification (+26 more)
...
Cohesion: 0.40
Nodes (4): Blocking finding, Evidence, G1-OP Partial Installation Review, Required decision

## Knowledge Gaps
- **151 isolated node(s):** `$schema`, `gate_id`, `decision`, `approved_at`, `scope_hash` (+146 more)
